...
import { CjsToolWebhookStreamService } from "./CjsToolWebhookStreamService.js";

/** Authenticates one webhook endpoint and routes deliveries to family services. */
export class CjsToolWebhookIngressSource
{
    ...
    } = {})
    {
        ...
        this.#lane = new CjsToolRealtimeSerialLane({ maxPending: maxPendingDeliveries });
    ...
    Register({ id, topics })
    {
        ...
        CjsToolRealtimeProtocol.assertServiceId(id);
        ...
        try
        {
            return await this.#lane.Enqueue(async () =>
            {
                ...
                if (record)
                {
                    ...
                    if (record.complete)
                    {
                        return CjsToolWebhookStreamService.cloneResponse(record.response);
                    }
                }
