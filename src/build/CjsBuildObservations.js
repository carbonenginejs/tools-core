...
export class CjsBuildObservations
{
    ...
    static async read(dataDirectory)
    {
        ...
        {
            if (error?.code === "ENOENT") return new CjsBuildObservations(dataDirectory);
        ...
        return new CjsBuildObservations(dataDirectory, records);
    }
