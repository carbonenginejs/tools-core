 ...
 *
 * `CjsToolSdeTable.Find` filters with `json_extract(payload, ?)`, which SQLite can
 ...
 *
 * A derivation (`CjsToolSdeDerivations`) computes a *new answer* and is deliberately
 ...
 *
 * The predicate must be written the way `CjsToolSdeTable.Find` writes it, character
