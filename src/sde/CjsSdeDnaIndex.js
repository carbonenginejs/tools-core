 ...
 * byte-identical to the ones `CjsSde` emits — the lowercasing, the field
...
/**
 * Builds the reverse index over an already-loaded `CjsSde`.
 *
 * @param {Object} sde - a CjsSde holding the prepared tables
