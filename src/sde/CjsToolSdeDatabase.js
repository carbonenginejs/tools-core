...
import { RunDerivations } from "./CjsToolSdeDerivations.js";
import { CreateQueryIndexes, HasQueryIndexes } from "./CjsToolSdeQueryIndexes.js";
...
export class CjsToolSdeDatabase
{
     ...
     * @returns {Promise<CjsToolSdeDatabase>} open and writable; the caller closes it
     */
     ...
     * shape `LoadTables` returns and `CjsToolSde` consumes — so a build is a
...
export class CjsToolSdeTable
{
    ...
    async Find(field, value, options = {})
    {
        ...
        // the locality indexes in `CjsToolSdeQueryIndexes` do anything: SQLite
