import { CjsToolRealtimeChatContract } from "./CjsToolRealtimeChatContract.js";
...
export class CjsToolRealtimeChatBlockList
{
    ...
    constructor({ terms = [], users = [] } = {})
    {
        this.terms = CjsToolRealtimeChatBlockList.normalizeList(
            terms,
            "terms",
            CjsToolRealtimeChatContract.normalizeTermSelector,
        );
        this.users = CjsToolRealtimeChatBlockList.normalizeList(
            users,
            "users",
            CjsToolRealtimeChatContract.normalizeUserSelector,
        );
        Object.freeze(this);
    }
    ...
    BlocksTerm(room, text)
    {
        ...
        return this.terms.some(selector =>
            CjsToolRealtimeChatContract.matchesTermBlock(selector, room, text));
    }
    ...
    BlocksUser(room, author)
    {
        return this.users.some(selector =>
            CjsToolRealtimeChatContract.matchesUserBlock(selector, room, author));
    }
