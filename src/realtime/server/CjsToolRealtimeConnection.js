...
import {
    ...
    REALTIME_ROUTE,
} from "../CjsToolRealtimeProtocol.js";
...
export class CjsToolRealtimeConnection
{
    ...
    constructor({ hub, transport, origin = null, clientAddress = null })
    {
        ...
        this.#inboundLane = new CjsToolRealtimeSerialLane();
        this.#inboundBytes = 0;
    ...
    {
        return this.#EnqueueMessage(CjsToolRealtimeError.from(error).ToMessage(requestId));
    }
