...
import { CjsToolRealtimeConnection } from "./CjsToolRealtimeConnection.js";
import { CjsToolRealtimeOperationStoreMemory } from "./CjsToolRealtimeOperationStoreMemory.js";
import { CjsToolRealtimeServiceRegistry } from "./CjsToolRealtimeServiceRegistry.js";
import { CjsToolRealtimeServiceController } from "../internal/CjsToolRealtimeServiceController.js";
import { CjsToolRealtimeSerialLane } from "../internal/CjsToolRealtimeSerialLane.js";

/** Transport-neutral realtime service host and protocol coordinator. */
export class CjsToolRealtimeHub
{
    ...
    constructor({
        ...
        operationStore = new CjsToolRealtimeOperationStoreMemory(),
        clock = () => Date.now(),
        createId = CjsToolRealtimeHub.createId,
        limits = {},
    } = {})
    {
        if (!authority || typeof authority.Authenticate !== "function")
        {
            throw new TypeError("CjsToolRealtimeHub requires a session authority");
        }
        ...
        this.limits = CjsToolRealtimeHub.normalizeLimits(limits);
        this.#controllers = new Map();
        this.#connections = new Map();
        this.#lifecycleLane = new CjsToolRealtimeSerialLane();
        this.status = "stopped";
    ...
    OpenConnection(options)
    {
        ...
        const connection = new CjsToolRealtimeConnection({ hub: this, ...options });
